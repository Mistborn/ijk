...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pago.kreinto'
        db.add_column('alighi_pago', 'kreinto',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pago-kreinto', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pago.kreinto'
        db.delete_column('alighi_pago', 'kreinto_id')
