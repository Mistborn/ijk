...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pago.lasta_redaktanto'
        db.add_column('alighi_pago', 'lasta_redaktanto',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pagoredaktanto', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pago.lasta_redaktanto'
        db.delete_column('alighi_pago', 'lasta_redaktanto_id')
