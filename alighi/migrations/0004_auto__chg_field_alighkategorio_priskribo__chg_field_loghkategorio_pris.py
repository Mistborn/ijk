...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlighKategorio.priskribo'
        db.alter_column('alighi_alighkategorio', 'priskribo', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'LoghKategorio.priskribo'
        db.alter_column('alighi_loghkategorio', 'priskribo', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Pagmaniero.priskribo'
        db.alter_column('alighi_pagmaniero', 'priskribo', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'AghKategorio.priskribo'
        db.alter_column('alighi_aghkategorio', 'priskribo', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'LandoKategorio.priskribo'
        db.alter_column('alighi_landokategorio', 'priskribo', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AlighKategorio.priskribo'
        db.alter_column('alighi_alighkategorio', 'priskribo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'LoghKategorio.priskribo'
        db.alter_column('alighi_loghkategorio', 'priskribo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Pagmaniero.priskribo'
        db.alter_column('alighi_pagmaniero', 'priskribo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'AghKategorio.priskribo'
        db.alter_column('alighi_aghkategorio', 'priskribo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'LandoKategorio.priskribo'
        db.alter_column('alighi_landokategorio', 'priskribo', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'alighi.pago': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kreinto': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pago-kreinto'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'partoprenanto': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alighi.Partoprenanto']"}),
            'respondeculo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pago-respondeculo'", 'to': "orm['auth.User']"}),
            'rimarko': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'sumo': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'valuto': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alighi.Valuto']"})
        },
