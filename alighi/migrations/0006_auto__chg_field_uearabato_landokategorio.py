...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UEARabato.landokategorio'
        db.alter_column('alighi_uearabato', 'landokategorio_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alighi.LandoKategorio'], unique=True))

    def backwards(self, orm):

        # Changing field 'UEARabato.landokategorio'
        db.alter_column('alighi_uearabato', 'landokategorio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alighi.LandoKategorio'], unique=True))
