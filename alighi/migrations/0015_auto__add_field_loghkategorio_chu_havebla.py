...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LoghKategorio.chu_havebla'
        db.add_column('alighi_loghkategorio', 'chu_havebla',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LoghKategorio.chu_havebla'
        db.delete_column('alighi_loghkategorio', 'chu_havebla')
    ...
    models = {
        ...
        'alighi.lando': {
            'Meta': {'ordering': "('xnomo',)", 'object_name': 'Lando'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'alighi.loghkategorio': {
            ...
            'chu_havebla': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nomo': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
        ...
        'alighi.partoprenanto': {
            ...
            'alighila_kotizo': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
