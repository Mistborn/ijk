...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partoprenanto.alighila_kotizo'
        db.add_column('alighi_partoprenanto', 'alighila_kotizo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partoprenanto.alighila_kotizo'
        db.delete_column('alighi_partoprenanto', 'alighila_kotizo')
