...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SenditaOficialajho.alshutodato'
        db.add_column('alighi_senditaoficialajho', 'alshutodato',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 2, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SenditaOficialajho.alshutodato'
        db.delete_column('alighi_senditaoficialajho', 'alshutodato')
